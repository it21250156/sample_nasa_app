...
const SpiritPhotos = () => {
  ...
  useEffect(() => {
    const fetchRoverPhotos = async () => {
      ...
      const apiUrl = `https://api.nasa.gov/mars-photos/api/v1/rovers/${roverName}/photos?sol=5&api_key=${apiKey}&per_page=1`;
          ...
          {photos.map((photo) => (
            <div class="group relative border border-transparent rounded-md hover:border-white hover:scale-105">
              ...
              >
                <img
                  src={photo.img_src}
                  alt="Taken by Spirit Rover on Mars"
